...
export const DownloadBut = () => {
  ...
  const handleDownload = (e) => {
    e.preventDefault();
    const message = language === 'ض' 
      ? 'عذراً، ملف السيرة الذاتية غير متوفر حالياً.' 
      : 'Sorry, the CV file is currently unavailable.';
    alert(message);
  };
      ...
      <div className="containerD max-md:bottom-[35%] bottom-[10%] xl:rtl:right-full
       ...
       xl:left-[110%]">
        <div className="tooltip rtl:left-[66%] ltr:left-[36%]">
          <p className="font-[Tajawal] font-medium even:text-[#a19e97]">Download My CV</p>
        </div>
